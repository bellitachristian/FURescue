    ...
    <div class="col-md">
        <div class="card shadow mb-4">
            <div
                ...
                <div>
                    <a href="{{route('pet.view')}}"><button class="btn btn-secondary">Back</button></a>
                </div>
            </div>
            <!-- Animal Content -->
            <div class="card-body">
                    ...
                    @foreach($animal as $anim)
                        <tr>
                            ...
                            <td style="text-align:center">
                                <a href="{{route('restore_pet.petowner',$anim->id)}}"><button class="btn btn-dark">Restore</button></a>
                            </td>
                        </tr> 
