            ...
            <div class="card-body">
                <div class="form-group-row" style="display:flex">
                    <div class="col-sm" style="height:500px">
                        ...
                        <input type="text" disabled value="{{$animal->gender}}" class="form-control form-control-sm">

                        <label class="text-sm">Breed</label>
                        <input type="text " disabled value="{{$animal->breed}}" class="form-control form-control-sm">
                    </div>    
                </div>                                                
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="form-group-row">   
                    <div class="col-sm flex-1">
                        <h2>Allocate Deworming</h2>
                        <label class="text-sm">Deworm Name</label>
                        <input type="text" readOnly value ="{{$deworm->dew_name}}" name="dew_name"  class="form-control form-control-sm">
                                        
                        <label class="text-sm">Description</label>
                        <input type="text" readOnly value ="{{$deworm->dew_desc}}" name="dew_desc"  class="form-control form-control-sm">

                        <form action="{{url('/AllocationDeworm/petowner/'.$animal->id).'/'.$deworm->id}}" method="POST">
                            @csrf
                            <label class="text-sm">Date Dewormed</label>
                            <input type="date"  class="form-control form-control-sm" id="vaccine_date" name="dew_date" required>
                                            
                            <label class="text-sm">Deworm Active</label>
                            <select class="form-control form-control-sm" id="vaccine_effective" name="dew_effect" required>
                                <option value="">--Select Deworming Effectiveness Span--</option>
                                <option value="3">3-Months</option>
                                <option value="1">1-Year</option>
                                <option value="custom">Custom</option>
                            </select>
                            <label class="text-sm">Deworm Expiry</label>
                            <input type="date"  class="form-control form-control-sm" id="vaccine_expiry" name="dew_expiry"  required> <br>
                            
                            <a href="{{url('AllocateVaccine/petowner/'.$animal->id)}}"><button class="btn btn-secondary" type="button">Back</button></a>
                            <button class="btn btn-danger" id="btn" type="submit">Apply Deworming</button>
                        </form>
