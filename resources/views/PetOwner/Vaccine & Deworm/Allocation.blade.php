            ...
            <div class="card-body">
                <div class="form-group-row">   
                    <div class="col-sm flex-1">
                        ...
                        <form action="{{url('/AllocationVaccine/petowner/'.$animal->id).'/'.$vaccine->id}}" method="POST">
                            @csrf
                            ...
                            <a href="{{url('AllocateVaccine/petowner/'.$animal->id)}}"><button type="button" class="btn btn-secondary">Back</button></a>
