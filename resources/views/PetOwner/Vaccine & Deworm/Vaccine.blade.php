    ...
    <div class="col-md">
            <div class="card shadow mb-4">
                ...
                <div
                    ...
                    <div>
                        <a href="{{route('view_archived_vaccine.petowner')}}"><button class="btn btn-danger">View Archived Vaccine</button></a>
                    </div>
                </div>
...
<div class="col-md">
        <div class="card shadow mb-4">
            ...
            <div
                ...
                <div>
                    <a href="{{route('view_archived_deworm.petowner')}}"><button class="btn btn-danger">View Archived Deworm</button></a>
                </div>
            </div>  
<!-- Vaccine and deworm Content -->
<div class="card-body">
