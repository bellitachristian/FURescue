 ...
 <div class="row justify-content-center">
        ...
        <div style="margin-top:1%" class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div>
                        <h7 style="text-align:center">Click to Upload Valid Documents(e.g. Screenshots of Valid IDs)</h7>
                    </div>
                    <div id="uploaded_image">
                    </div>
                    <form id="dropzoneForm" enctype="multipart/form-data" action="{{route('valid.reupload.petowner') }}" class="dropzone">
                        @csrf
                    </form>
                ...
                <form action="{{route('wait.response.petowner',$petowner->id)}}" method="POST">
                    @csrf
...
load_images();
  ...
  {
    $.ajax({
      url:"{{ route('fetch.valid.petowner',$petowner->id) }}",
  ...
  $(document).on('click', '.remove_image', function(){
    ...
    $.ajax({
      url:"{{ route('valid.delete.petowner')}}",
      data:{name : name},
      success:function(data){
