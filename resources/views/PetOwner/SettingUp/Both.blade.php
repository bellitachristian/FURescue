<form action="{{route('bothlife.stage.petowner')}}" method="POST">
@csrf
...
<main style="margin-top:30px" class="grid">
    ...
    <div class="option_inner puppy">
        <img src="{{asset('images/puppy.jpg')}}" height="230" width="220" alt="Puppy">
        <div class="tickmark"></div>
    ...
    <div class="option_inner adolescent">
        <img src="{{asset('images/adolescent.jpg')}}" height="230" width="220"  alt="Adolescent">
        <div class="tickmark"></div> 
    ...
    <div class="option_inner adult">
        <img src="{{asset('images/adult.jpg')}}" height="230" width="220" alt="Adult">
        <div class="tickmark"></div>
    ...
    <div class="option_inner puppy">
        <img src="{{asset('images/senior.jpg')}}" height="230" width="220"  alt="Senior">
        <div class="tickmark"></div>
            <h2 style="color:black; font-weight:bold">Senior</h2>
