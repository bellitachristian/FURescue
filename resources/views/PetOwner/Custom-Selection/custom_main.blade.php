...
<div class="row">
    ...
    <article>
        ...
        <div class="text">
            <a href="{{route('selection.category.petowner')}}"><button style="margin-top:10px" class="btn btn-danger">CATEGORY</button>
            </a>
        </div>
    </article>  
    <article>
        ...
        <div class="text">
            <a href="{{route('selection.breed.petowner')}}"><button style="margin-top:10px" class="btn btn-danger">BREED</button>
            </a>
        </div>
    </article>  
    <article>
        ...
        <div class="text">
            <a href="{{route('selection.adoption.petowner')}}"><button style="margin-top:10px; " class="btn btn-danger">ADOPTION FEE</button>
            </a>
        </div>
    </article>  
    </main>   
