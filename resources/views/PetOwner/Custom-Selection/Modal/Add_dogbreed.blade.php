<!-- Add Breed Modal -->
<div class="modal fade"  id="AddDogBreedModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            ...
            <form action="{{route('dogbreed.add.petowner')}}" method="POST">
                @csrf
...
<div class="modal fade"  id="DeleteDogbreed" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            ...
            <form action="/customselection/deletedog_breed/petowner/" method="POST" id="deleteform1">
                @csrf
                <div class="modal-body">
