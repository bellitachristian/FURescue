            ...
            <div class="card-body">
                <div class="form-group-row">   
                    <div class="col-sm flex-1">
                        ...
                        <form action="{{url('/AllocationDeworm/'.$animal->id).'/'.$deworm->id}}" method="POST">
                            @csrf
                            ...
                            <a href="{{url('AllocateVaccine/'.$animal->id)}}"><button class="btn btn-secondary" type="button">Back</button></a>
