                    ...
                    <table id="datatable" class="table table-light table-hover">
                        ...
                        @foreach($notallocated as $vaccine)
                            <tr>
                                ...
                                <a href="{{url('AllocationVaccine/'.$animal->id.'/'.$vaccine['id'])}}" class="btn btn-danger">Apply to Pet</a>  
                                </td> 
                            </tr> 
                            ...
                            <table id="datatable1" class="table table-light table-hover">
                                ...
                                @foreach($notallocated1 as $deworm)
                                    <tr>
                                        ...
                                        <td style="text-align:center"> 
                                        <a href="{{url('AllocationDeworm/'.$animal->id.'/'.$deworm['id'])}}" class="btn btn-danger">Apply to Pet</a>    
                                        </td> 
                                    </tr> 
                                @endforeach
