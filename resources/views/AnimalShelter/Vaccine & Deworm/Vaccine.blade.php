...
@include("Modal.VaccineModal")
@include("Modal.DewormModal")
@endsection
@push("js")
        ...
        $(document).ready(function(){
          var table = $('#datatable').DataTable();
            ...
            table.on('click','#edit', function(){
                ...
                $('#editform').attr('action','/vaccine/editvac/'+data[0]);
        ...
        $(document).ready(function(){
          var table = $('#datatable').DataTable();
            ...
            table.on('click','#delete', function(){
                ...
                $('#deleteform').attr('action','/vaccine/deletevac/'+data[0]);
        ...
        $(document).ready(function(){
          var table = $('#datatable1').DataTable();
            ...
            table.on('click','#edit1', function(){
                ...
                $('#editform1').attr('action','/deworm/editdeworm/'+data[0]);
        ...
        $(document).ready(function(){
          var table = $('#datatable1').DataTable();
            ...
            table.on('click','#delete1', function(){
                ...
                $('#deleteform1').attr('action','/deworm/deletedeworm/'+data[0]);
