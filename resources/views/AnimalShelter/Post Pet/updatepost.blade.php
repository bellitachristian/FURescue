        ...
        <div class="card-header">
          ...
          <form action="" method="POST" id="update">
            <div style="display:flex">
              <div class="col-sm">
                <br>
              <button type="submit"  style="padding:10px;width:150px" class="btn btn-danger">Update Post</button>     
              </div> 
              <div class="col-sm-3">
            ...
            <div class="card-body">
                <div style="display:flex">   
                    <div class="col-sm">
                        ...
                        <form id="dropzoneForm" enctype="multipart/form-data" action="{{ route('post.uploadphoto',$animal->id) }}" class="dropzone">
                            @csrf
                        </form>
...
load_images();
  ...
  {
    $.ajax({
      url:"{{ route('post.fetch',$animal->id) }}",
  ...
  if(categID){
    $.ajax({
      type:"GET",
      url:"{{route('get.fee')}}?categ_id="+categID,
...
$("#update").submit(function(e){
      ...
      $.ajax({
        url: "{{route('post.pet.update',$animal->id)}}",
        type:"POST",
        data:{
          feeid:feeid,
          feeprice:feeprice,
