<form action="{{route('cat.fee')}}" method="POST">
@csrf
<main style="margin-top:30px" class="grid">
    ...
    <div class="option_inner kitten">
        <img src="images/junior.png" style="height:300px"  alt="Kitten">
    ...
    <div class="option_inner junior">
        <img src="images/prime.jpg" style="height:300px"   alt="Junior">
        <div class="tickmark"></div> 
    ...
    <div class="option_inner prime">
        <img src="images/mature.jpg" style="height:300px"   alt="Prime">
        <div class="tickmark"></div>
