<form action="{{route('bothbreed.save')}}" method="POST">
@csrf
...
<main style="margin-top:30px" class="grid">
    ...
    <div class="option_inner kitten">
        <img src="images/adolescent.jpg" height="230" width="220" alt="Aspin">
    ...
    <div class="option_inner junior">
        <img src="images/adult.jpg" height="230" width="220"  alt="Cross Breed">
        <div class="tickmark"></div> 
...
<main style="margin-top:30px" class="grid">
    ...
    <div class="option_inner kitten">
        <img src="images/junior.png" height="230" width="220" alt="Puspin">
        <div class="tickmark"></div>
    ...
    <div class="option_inner junior">
        <img src="images/prime.jpg" height="230" width="220"  alt="Junior">
        <div class="tickmark"></div> 
            <h2 style="color:black; font-weight:bold">Cross-breed</h2>
...
<div class="modal fade"  id="DeleteDogbreed" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            ...
            <form action="{{route('bothbreed.delete')}}" method="POST" id="deleteform">
                @csrf
