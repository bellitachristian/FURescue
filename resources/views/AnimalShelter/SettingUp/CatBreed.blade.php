<form action="{{route('catbreed.save')}}" method="POST">
@csrf
...
<main style="margin-top:30px" class="grid">
    ...
    <div class="option_inner junior">
        <img src="images/prime.jpg" height="230" width="220"  alt="Cross-breed">
        <div class="tickmark"></div> 
...
<div class="modal fade"  id="Deletebreed" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            ...
            <form action="{{route('catbreed.delete')}}" method="POST" id="deleteform">
                @csrf
