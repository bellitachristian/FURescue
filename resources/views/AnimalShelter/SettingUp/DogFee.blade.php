<form action="{{route('dog.fee')}}" method="POST">
@csrf
<main style="margin-top:30px" class="grid">
    ...
    <div class="option_inner kitten">
        <img src="images/adolescent.jpg" style="height:300px"  alt="Kitten">
    ...
    <div class="option_inner junior">
        <img src="images/adult.jpg" style="height:300px"   alt="Junior">
        <div class="tickmark"></div> 
    ...
    <div class="option_inner prime">
        <img src="images/senior.jpg" style="height:300px"   alt="Prime">
        <div class="tickmark"></div>
