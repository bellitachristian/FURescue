...
<div class="modal fade"  id="EditPolicy" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            ...
            <form action="/AdoptionPolicy/edit" method="POST" id="editform">
                @csrf
                <div class="modal-body">
                <div class="form-group row">
                        <div class="col-md"> 
        ...
        $(document).ready(function(){
          var table = $('#datatable').DataTable();
            ...
            table.on('click','#delete', function(){
                ...
                $('#deleteform').attr('action','/AdoptionPolicy/delete/'+data[0]);
        ...
        $(document).ready(function(){
          var table = $('#datatable').DataTable();
            ...
            table.on('click','#edit', function(){
                ...
                $('#editform').attr('action','/AdoptionPolicy/edit/'+data[0]);
