...
@if($catcheck > 0 && $dogcheck == 0)
@include('AnimalShelter.Custom-Selection.Modal.Add_catbreed')
@elseif($dogcheck > 0 && $catcheck == 0)
@include('AnimalShelter.Custom-Selection.Modal.Add_dogbreed')
...
$(document).ready(function(){
    ...
    table.on('click','#delete1', function(){
        ...
        var data = table.row($tr).data();
        console.log(data);
        $('#deleteform').attr('action','/customselection/deletecat_breed/'+data[0]);
...
$(document).ready(function(){
    ...
    table.on('click','#delete', function(){
        ...
        var data = table.row($tr).data();
        console.log(data);
        $('#deleteform1').attr('action','/customselection/deletedog_breed/'+data[0]);
