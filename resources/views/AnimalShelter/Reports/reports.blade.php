    ...
    <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 text-center justify-content-center px-xl-6 aos-init aos-animate" data-aos="fade-up">
        <div class="col my-3">
            <div class="card border-hover-primary hover-scale">
                ...
                <div class="card-footer bg-transparent "><a href="{{route('adoptionhistory.shelter')}}" class="btn btn-primary">View History</a></div>
            </div>
        </div>
        <div class="col my-3">
            <div class="card border-hover-primary hover-scale">
                ...
                <div class="card-footer bg-transparent "><a href="{{route('paymenthistory.shelter')}}" class="btn btn-primary">View History</a></div>
            </div>
        </div>
        <div class="col my-3">
            <div class="card border-hover-primary hover-scale">
                <div class="card-body">
                    <div class="text-primary mb-3">
                        <img src="{{asset('images/donation-history.PNG')}}" style="height: 70px; width: 70px;">
                    </div>
        ...
        <div class="col my-3">
            <div class="card border-hover-primary hover-scale">
                ...
                <div class="card-footer bg-transparent "><a href="{{route('view.revenue.shelter')}}" class="btn btn-primary">View History</a></div>
            </div>
        </div>            
    </div>
</div>
