...
<!-- Animal Content -->
<div class="card-body">
    <form action="{{url('/'.$animal->id)}}"  method="POST" enctype="multipart/form-data">
        @csrf 
        <div class="form-group-row" style="display:flex">
            ...
            <div class="col-sm-3 flex-1">
                    ...
                    <input type="text" value ="{{$animal->age}}"  class="form-control form-control-sm" id="age" name="age">
        ...
        <div style="float:right; margin-top:-1.5%">
            <a href="/AnimalManagement"><button class="btn btn-secondary" type="button">Back</button></a>
